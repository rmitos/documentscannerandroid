...
public class ResultFragment extends Fragment {
            ...
            AsyncTask.execute(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        Uri uri = Utils.getUri(requireContext(), bitmap);
    ...
    private class BWButtonClickListener implements View.OnClickListener {
        ...
        public void onClick(final View v) {
            ...
            AsyncTask.execute(new Runnable() {
                ...
                public void run() {
                    try {
                        transformed = ((ScanActivity) requireActivity()).getBWBitmap(original);
    ...
    private class MagicColorButtonClickListener implements View.OnClickListener {
        ...
        public void onClick(final View v) {
            ...
            AsyncTask.execute(new Runnable() {
                ...
                public void run() {
                    try {
                        transformed = ((ScanActivity) requireActivity()).getMagicColorBitmap(original);
                    } catch (final OutOfMemoryError e) {
                        requireActivity().runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
    ...
    private class GrayButtonClickListener implements View.OnClickListener {
        ...
        public void onClick(final View v) {
            ...
            AsyncTask.execute(new Runnable() {
                ...
                public void run() {
                    try {
                        transformed = ((ScanActivity) requireActivity()).getGrayBitmap(original);
                    } catch (final OutOfMemoryError e) {
                        requireActivity().runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
    ...
    private class RotateButtonClickListener implements View.OnClickListener {
        ...
        public void onClick(final View view) {
            showProgressDialog(getResources().getString(R.string.rotating));
            AsyncTask.execute(new Runnable() {
                @Override
                public void run() {
                    try {
                        transformed = rotateBitmap(original);
    ...
    protected synchronized void showProgressDialog(String message) {
        ...
        progressDialogFragment.show(getChildFragmentManager(), null);
    }
